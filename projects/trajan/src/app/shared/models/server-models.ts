...
export interface ApiEndpoints<T> {
    GET: {
        ...
        '/{project}/navroot/{path}': {
            ...
            responseType: NavigationResponse<T>;
            responseTypes: {
                /** Loaded navigation. */
                200: NavigationResponse<T>;
            };
        };
        ...
        '/{project}/nodes': {
            ...
            responseType: NodeListResponse<T>;
            responseTypes: {
                /** Loaded list of nodes. */
                200: NodeListResponse<T>;
            };
        };
    ...
    POST: {
        ...
        '/{project}/nodes/{nodeUuid}': {
            request: {
                ...
                queryParams?: {};
                body: NodeUpdateRequest<T>;
            };
            responseType: NodeResponse<T> | GenericMessageResponse;
            responseTypes: {
                /** Updated node. */
                200: NodeResponse<T>;
                /** Malformed request */
...
export type FieldMapFromServer<T extends any> = T & {
...
export interface NavigationElementFromServer<T> {
    /** List of further child elements of the node. */
    readonly children?: NavigationElementFromServer<T>[];
    readonly node?: NodeResponse<T>;
 ...
 */
export interface NavigationResponse<T> {
    /** List of further child elements of the node. */
    readonly children?: NavigationElementFromServer<T>[];
    readonly node?: NodeResponse<T>;
    /** Uuid of the node within this navigation element. */
...
export interface NodeCreateRequest<T> {
    /** Dynamic map with fields of the node language specific content. */
    readonly fields: FieldMapFromServer<T>;
